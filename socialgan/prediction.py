...
parser.add_argument('--input_type', default='single', choices=['single','multi'])
parser.add_argument('--ped_id', default='1')
...
def main(args):
    folder = Path('output',args.date, args.input_type, args.ped_id)
    folder.mkdir(parents=True, exist_ok=True)
    path_datasets = Path('socialgan/datasets/original',args.date, args.input_type, args.ped_id)
